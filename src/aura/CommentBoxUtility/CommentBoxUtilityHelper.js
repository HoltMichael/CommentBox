({
    connectCometd : function(component) {
        ...
        cometd.handshake(function(handshakeReply) {
            if (handshakeReply.successful) {
                ...
                var newSubscription = cometd.subscribe('/event/CommentBox__Email_Event__e',
    ...
    onReceiveNotification : function(component, platformEvent) {
        ...
        var newNotification = {
          ...
          message : platformEvent.data.payload.CommentBox__Email_Subject__c,
          caseNumber : platformEvent.data.payload.CommentBox__Case_Number__c,
          caseURL : window.location.protocol+'//'+window.location.hostname + '/' + platformEvent.data.payload.CommentBox__Case_ID__c
        };
        ...
        if (!component.get('v.isMuted')){
          helper.displayToast(component, 'info', newNotification.caseNumber, newNotification.message);
        }
    },

    displayToast : function(component, type, caseNumber, message) {
        var toastEvent = $A.get('e.force:showToast');
        toastEvent.setParams({
            type: type,
            title: 'Case Comment Received: ' + caseNumber,
            message: message
        });
        toastEvent.fire();
    }
